...
object TestIsSorted {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("Array: " + arrays(0).mkString(", ") + " Expected: true")
    println("Actual: %b".format(isSorted(arrays(0), gtInt)))
    println("Array: " + arrays(1).mkString(", ") + " Expected: true")
    println("Actual: %b".format(isSorted(arrays(1), gtInt)))
    println("Array: " + arrays(2).mkString(", ") + " Expected: true")
    println("Actual: %b".format(isSorted(arrays(2), gtInt)))
    println("Array: " + arrays(3).mkString(", ") + " Expected: true")
    println("Actual: %b".format(isSorted(arrays(3), gtInt)))
    println("Array: " + arrays(4).mkString(", ") + " Expected: false")
    println("Actual: %b".format(isSorted(arrays(4), gtInt)))
    println("Array: " + arrays(5).mkString(", ") + " Expected: false")
    println("Actual: %b".format(isSorted(arrays(5), gtInt)))
  }
}
